...
$total_pages = $db->query("SELECT * FROM products WHERE Product_Status = 'Active' ORDER BY id DESC")->num_rows;
...
if ($stmt = $db->prepare("SELECT id,image1,product_name,price FROM products WHERE Product_Status = 'Active' ORDER BY id DESC LIMIT ?,?")) {
	...
	$result = $stmt->get_result();
							...
							<div class="prd">
								...
								<div class="prd-info">
									<h3><a href="product-details.php?id=<?php echo $row['id'];?>"><?php echo $row['product_name'];?></a></h3>
